...
export function getValueOrDefault<T = any>(
  ...
  key?: 'path' | 'webpack' | 'webpackPath' | 'entryFile' | 'sourceRoot' | 'exec' | 'builder' | 'typeCheck',
  options: Input[] = [],
  defaultValue?: T
): T {
...
export function getValueOfPath<T = any>(object: Record<string, any>, propertyPath: string): T {
